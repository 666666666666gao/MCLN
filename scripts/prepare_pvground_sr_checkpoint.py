"""Fetch the pinned official Sr3D parent and inspect it on CPU; never train."""
import datetime
import hashlib
import json
import os
...
filename = 'PV-Ground_SR3D.pth'
plan = dict(dataset='sr3d', filename=filename, bytes=829830168,
    sha256='a4a14b0090947177a648703ad6de094246891d89174fffa56fe454f730dbe3dc',
...
cache = Path('C:/Users/gb/.codex/tmp/mcln_pv_sr_transfer_20260908')
...
print('SR_PARENT_LOCAL_VERIFIED '+json.dumps(download),flush=True)
