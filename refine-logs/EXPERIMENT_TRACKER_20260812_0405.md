...
| R1-F | V51 anchor-safe formal | rejected | one full epoch / 9508 validation | learned 0.577829/0.461401; Mask 0.596866/0.490114/0.417830; stopped |
| R2-P | parent-score-preserving promotion | implementing | parent score immutable; candidate margin; no Mask output residual | pending smoke |
...
| R3 | V52 QTM-3D | pending R2-P evidence | query-specific text masks | pending |
