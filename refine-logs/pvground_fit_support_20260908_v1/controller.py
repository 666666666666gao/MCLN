...
with open(spec["gpu_lock"],"a") as lock:
    ...
    with (root/"run.log").open("xb") as log:
        result=subprocess.run(['/root/autodl-tmp/mcln_pvground_runtime_20260908_v1/venv/bin/python', '-u', '/root/autodl-tmp/mcln_pvground_fit_support_20260908_v1/audit.py'],env=env,stdout=log,stderr=subprocess.STDOUT)
