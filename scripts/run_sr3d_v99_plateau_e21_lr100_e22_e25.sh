...
readonly E19_E20_RUN="${OUTPUT_ROOT}/backbone/sr3d_mcln_joint_butdcls_v99_plateau_lr10_e16_e20_b12a2_w4p2_20260825_202643/sr3d/sr3d_mcln_joint_butdcls_v99_plateau_lr10_e16_e20_b12a2_w4p2/1787660811"
readonly E21_RUN="${OUTPUT_ROOT}/backbone/sr3d_mcln_joint_butdcls_v99_plateau_e20_extension_e21_e28_b12a2_w4p2_20260826_121404/sr3d/sr3d_mcln_joint_butdcls_v99_plateau_e20_extension_e21_e28_b12a2_w4p2/1787717651"
readonly REQUIRED_RESUME_CHECKPOINT="${E21_RUN}/ckpt_epoch_21.pth"
readonly REQUIRED_RESUME_SHA256="f6409566b0ab3dcbe7ddf3463b775aaf31e1856f3854be5c9125efaca37d8940"
readonly REQUIRED_RESUME_EPOCH=21
readonly REQUIRED_E19_RECEIPT="${E19_E20_RUN}/eval_metrics_epoch_19.json"
readonly REQUIRED_E19_RECEIPT_SHA256="ca4b2b2c0edaf04ca701a94c968afe41dfaada19e1c2082df3a4625fcb0cc619"
readonly REQUIRED_E20_RECEIPT="${E19_E20_RUN}/eval_metrics_epoch_20.json"
readonly REQUIRED_E20_RECEIPT_SHA256="a863b2ab9bff4d6c16fe211979b1689daae8792c3edef94598880c364b91b263"
readonly REQUIRED_E21_RECEIPT="${E21_RUN}/eval_metrics_epoch_21.json"
readonly REQUIRED_E21_RECEIPT_SHA256="f35cf0a65eb8f766ed26752dd9910c98a40019b246e2f83346017268f2af7f17"
...
readonly EXP="sr3d_mcln_joint_butdcls_v99_plateau_e21_lr100_e22_e25_b12a2_w4p2"
...
e19_path, e20_path, e21_path, checkpoint_path = sys.argv[1:]
expected_hits = {19: 11976, 20: 11861, 21: 11914}
observed_hits = {}
...
print(
    "SR3D_E21_LR100_PREFLIGHT=PASS epoch=21 current_lrs={} "
    "scheduler_steps={} plateau_hits={}".format(
        current_lrs, scheduler["last_epoch"], observed_hits
    )
)
PY
...
flock -u 8
exec 8>&-
echo "SR3D_E21_LR100_RESOURCE_PREFLIGHT=PASS gpu_mib=${gpu_used} free_gib=${free_gb}"
