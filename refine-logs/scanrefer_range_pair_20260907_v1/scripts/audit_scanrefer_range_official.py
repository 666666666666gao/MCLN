...
from scripts.evaluate_scanrefer_range_official import promotion_check
from scripts.scanrefer_data_contract import verify_scanrefer_superpoints


ARMS = ['protected_v99', 'center_v99', 'local_v99']
...
def audit_rows(directory):
    ...
    return {'integrity_pass': True, 'formal_rows': 9508, 'metrics': actual,
            ...
            'system_extent_minus_center': compare(records['center_v99'], records['local_v99']),
            'native_extent_minus_center': rec_compare(native['center_v99'], native['local_v99']),
            'system_center_minus_protected': compare(records['protected_v99'], records['center_v99']),
...
def main():
    ...
    result['schema'] = 'mcln-scanrefer-range-official-audit-v1'
