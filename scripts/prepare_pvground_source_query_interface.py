...
root='/root/autodl-tmp/mcln_pvground_source_query_interface_20260908_v3'
archive=repo/'refine-logs/pvground_source_query_interface_20260908_v3'
runtime='/root/autodl-tmp/mcln_pvground_runtime_20260908_v1'
model_source='/root/autodl-tmp/mcln_pvground_source_query_source_20260908_v1/PV-Ground'
...
s=c.open_sftp()
for dependency in ['mcln_pvground_scanrefer_finetune_20260908_emptypool_v1','mcln_pvground_scanrefer_endpoint_audit_20260908_emptypool_v1','mcln_pvground_scanrefer_formal_20260908_emptypool_v1']:
...
helper='''    replay_records=[]
    ...
    def paired_replay(inputs,label):
        ...
        replay_records.append(dict(mode=label,rec_keys_exact=rec_keys,rng_end_equal=True,
            source_output_max=source_outputs,mask_max_abs=mask_max))
        return output
...
code=replace_once(code,"    (args.output/'receipt.json').write_text",
    "    receipt.update(source_query_read=True,module_sha256=sha(Path(__file__).parent/'pvground_source_query.py'),model_source=str(model_source),source_port_sha256=sha(model_source.parent/'source_port.json'),zero_residual_eval_rec_replay_exact=True,train_layer_replay=train_layer_replay,replay_records=replay_records,mask_bitwise_equality_claim=False,new_parameters=sum(p.numel() for p in reader.parameters()))\n    (args.output/'receipt.json').write_text")
...
files={'check.py':code.encode(),'pvground_source_query.py':(repo/'models/pvground_source_query.py').read_bytes(),'controller.py':controller.encode(),'source_port.json':port_raw,'plan.md':(repo/'docs/PVG_SOURCE_QUERY_CONTROL_2026-09-08.md').read_bytes()}
...
command=['screen','-dmS','mcln_pvg_source_query_interface_v3','/root/miniconda3/envs/bdetr/bin/python','-u',root+'/controller.py']
