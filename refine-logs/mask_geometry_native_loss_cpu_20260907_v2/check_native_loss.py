...
root=Path('/root/autodl-tmp/mcln_mask_geometry_native_loss_cpu_20260907_v2'); source=Path('/root/autodl-tmp/mcln_native_range_preparation_20260907_v1/model_source'); training=Path('/root/autodl-tmp/mcln_scanrefer_mask_geometry_pair_20260907_v1')
