...
Updated: 2026-09-06 19:46 CST. Acceptance: §20.79; actual local-visual terminal and formal launch: §20.95.
...
| ScanRefer candidate local visual | Complete2482 updates/arm+6887 terminal;actual independent integrity PASS;local-baseline REC -20/-29 and local-control -12/-49 | Development REC negative;fixed pre-registered formal endpoint launched;no performance promotion |
| ScanRefer local visual official | Running19:39;PID39702;first12/9508 confirmed19:42;protected/local V99 plus native REC | Historical5572/4797 and paired REC floors+Scan Mask paper floors;next20:20 then240s;Nr/Sr only after actual formal promotion |
| ScanRefer local visual endpoint audit | Actual2482-step weights and6887 paired rows independently verified19:37;integrity PASS | Control66/local76 optimizer states at2482;frozen core/readouts unchanged;development REC negative;no weight downloads |
