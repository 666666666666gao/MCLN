...
root=Path('/root/autodl-tmp/mcln_pvground_scanrefer_endpoint_audit_20260917_rec_competition_v1')
...
while True:
    ...
    if (training/'controller.exit').is_file():
        ...
        if result.returncode==0:
            ...
            assert verified['integrity_pass'] and verified['rec_competition_verified']
