...
root=Path('/root/autodl-tmp/mcln_pvground_scanrefer_finetune_20260908_sourcequery_v1').resolve()
audit_root=Path('/root/autodl-tmp/mcln_pvground_scanrefer_endpoint_audit_20260908_sourcequery_v1')
formal=Path('/root/autodl-tmp/mcln_pvground_scanrefer_formal_20260908_sourcequery_v1')
...
assert not Path('/proc/25348').exists()
