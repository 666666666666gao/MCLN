"""Compare fixed D/F outputs to isolate the added training competition; no model execution."""
import argparse
import datetime
import hashlib
import json
...
def compare(spec, stage):
    ...
    assert configs[1]['rec_competition'] and not configs[0].get('rec_competition',False)
