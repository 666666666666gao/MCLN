...
archive = repo / 'refine-logs/pvground_referit3d_audit_cpu_20260908_v1'
archive.mkdir()
root = '/root/autodl-tmp/mcln_pvground_referit3d_audit_cpu_20260908_v1'
runtime = '/root/autodl-tmp/mcln_pvground_runtime_20260908_v1'
files = {'auditor.py': (repo / 'scripts/pvground_referit3d_rec_audit.py').read_bytes(),
         'readout.py': (repo / 'scripts/pvground_rec_readout.py').read_bytes(),
...
argv += [runtime + '/venv/bin/python', '-u', root + '/verify.py', '--runtime', runtime,
         '--readout', root + '/readout.py', '--auditor', root + '/auditor.py', '--output', root + '/receipt.json']
