...
- Two discarded training batches test actual optimization before starting either fitted arm. The full-model zero-initialization check first compares native and task outputs, loss, buffers and RNG on the same real ScanRefer batch.
