...
local = repo / 'refine-logs/mask_geometry_native_loss_cpu_20260907_v2'
remote = '/root/autodl-tmp/mcln_mask_geometry_native_loss_cpu_20260907_v2'
...
names = ['main_utils.py', 'models/losses.py', 'models/density_aware_target_box.py', 'scripts/native_mask_geometry_supervision.py',
