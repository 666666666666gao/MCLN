...
def main():
    ...
    assert interface['module_sha256']==spec['observation_module_sha256']==sha(output/'pvground_observation_query.py')
    ...
    def save_checkpoint(name,step_number,seen_rows):
        ...
        data.update(observation_state=True,observation_module_sha256=spec['observation_module_sha256'],source_query_read=True,source_query_module_sha256=spec['source_query_module_sha256'],source_port_sha256=sha(spec['source_port']))
    ...
    receipt.update(observation_state=True,observation_module_sha256=spec['observation_module_sha256'],source_query_read=True,source_query_module_sha256=spec['source_query_module_sha256'],source_port_sha256=sha(spec['source_port']),added_state_tensors=len(added),new_parameters=interface['new_parameters'])
