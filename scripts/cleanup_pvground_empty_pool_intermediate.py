...
root=Path('/root/autodl-tmp/mcln_pvground_scanrefer_finetune_20260908_emptypool_v1').resolve()
audit_root=Path('/root/autodl-tmp/mcln_pvground_scanrefer_endpoint_audit_20260908_emptypool_v1')
formal=Path('/root/autodl-tmp/mcln_pvground_scanrefer_formal_20260908_emptypool_v1')
...
assert not Path('/proc/20870').exists()
...
assert payload['empty_pool_mask'] is True
assert payload['empty_pool_module_sha256']==receipt['empty_pool_module_sha256']
