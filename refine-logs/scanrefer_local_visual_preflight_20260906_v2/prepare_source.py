...
root = Path('/root/autodl-tmp/mcln_scanrefer_local_visual_preflight_20260906_v2')
...
for name in ['models/candidate_local_visual.py', 'models/encoder_decoder_layers.py', 'models/mcln.py', 'tests/test_candidate_local_visual.py']:
