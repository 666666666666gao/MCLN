...
roots=['/root/autodl-tmp/mcln_pvground_scanrefer_finetune_20260917_task_observation_v1',
       '/root/autodl-tmp/mcln_pvground_scanrefer_endpoint_audit_20260917_task_observation_v1',
       '/root/autodl-tmp/mcln_pvground_scanrefer_formal_20260917_task_observation_v1']
...
s.close();c.close()
(repo/'refine-logs/pvground_scanrefer_finetune_20260917_task_observation_v1/observation_latest.json').write_text(json.dumps(record,indent=2)+'\n',encoding='utf-8')
