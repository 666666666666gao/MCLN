...
model=PVGround(cfg,num_class=256,num_queries=256,num_decoder_layers=6,
    ...
    butd=True,pointnet_ckpt=None,data_path='/root/autodl-tmp/DATA_ROOT_mcln_meshsp/',
    self_attend=config.self_attend)
# Same deterministic, non-persistent RoBERTa buffer treatment already used by ScanRefer.
