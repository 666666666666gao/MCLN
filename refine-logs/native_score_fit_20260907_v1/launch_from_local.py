...
archive = repo / 'refine-logs/native_score_fit_20260907_v1'
remote = '/root/autodl-tmp/mcln_native_score_fit_20260907_v1'
...
assert archive.is_dir()  # First preflight created it; no job was launched.
...
command = 'screen -L -Logfile ' + shlex.quote(remote + '/run.log') + ' -dmS mcln_native_score_fit_20260907_v1 bash ' + shlex.quote(remote + '/controller.sh')
...
launch = {'remote': remote, 'screen': 'mcln_native_score_fit_20260907_v1', 'command': command,
