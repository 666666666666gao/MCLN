...
with open("/root/autodl-tmp/mcln_v99_backbone_gpu0.lock","a") as lock:
    ...
    with (root/"run.log").open("xb") as log:
        result=subprocess.run(['/root/autodl-tmp/mcln_pvground_runtime_20260908_v1/venv/bin/python', '-u', '/root/autodl-tmp/mcln_pvground_empty_pool_check_20260908_v1/check.py'],env=env,stdout=log,stderr=subprocess.STDOUT)
