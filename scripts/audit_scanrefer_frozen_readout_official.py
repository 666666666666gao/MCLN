...
ARMS = ['protected_v99', 'native_only_v99', 'frozen_gt_v99']
...
def audit_rows(directory):
    ...
    assert receipt['schema'] == 'mcln-scanrefer-frozen-readout-official-v1'
    ...
    assert receipt['candidate_predeclared'] == 'frozen_gt_v99'
    ...
    promotion = promotion_check(actual['protected_v99'], actual['frozen_gt_v99'])
    ...
    return {'integrity_pass': True, 'formal_rows': 9508, 'metrics': actual,
            ...
            'system_frozen_gt_minus_protected': compare(records['protected_v99'], records['frozen_gt_v99']),
            'native_frozen_gt_minus_protected': rec_compare(native['protected_v99'], native['frozen_gt_v99']),
            'system_frozen_gt_minus_native_only': compare(records['native_only_v99'], records['frozen_gt_v99']),
            'native_frozen_gt_minus_native_only': rec_compare(native['native_only_v99'], native['frozen_gt_v99']),
            'system_native_only_minus_protected': compare(records['protected_v99'], records['native_only_v99']),
...
def main():
    ...
    result['schema'] = 'mcln-scanrefer-frozen-readout-official-audit-v1'
