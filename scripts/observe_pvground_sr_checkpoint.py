...
archive=Path(__file__).resolve().parents[1]/'refine-logs/pvground_sr_checkpoint_inspection_20260908_v1'
...
for name in ['PV-Ground_SR3D.pth.part','PV-Ground_SR3D.pth']:
