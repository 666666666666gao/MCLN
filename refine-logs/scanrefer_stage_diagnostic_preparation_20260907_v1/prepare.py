...
local = repo / 'refine-logs/scanrefer_stage_diagnostic_preparation_20260907_v1'
remote = '/root/autodl-tmp/mcln_scanrefer_stage_diagnostic_preparation_20260907_v1'
...
command = ('cd ' + shlex.quote(remote)
           ...
           + ' && /root/miniconda3/envs/bdetr/bin/python -m scripts.diagnose_scanrefer_readout_stages --help > help.txt')
