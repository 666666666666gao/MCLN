...
root='/root/autodl-tmp/mcln_pvground_pretrained_forward_20260908_v1'
...
archive=repo/'refine-logs/pvground_pretrained_forward_20260908_v1';archive.mkdir()
...
_,stdout,stderr=client.exec_command('screen -dmS mcln_pvg_forward_v1 bash -c '+shlex.quote(inner),timeout=30)
...
receipt={'time_cst':datetime.datetime.now(datetime.timezone(datetime.timedelta(hours=8))).isoformat(),'process':process.strip(),'screen':'mcln_pvg_forward_v1','estimate_seconds':[60,180],'optimizer_steps':0,'formal_rows':0}
