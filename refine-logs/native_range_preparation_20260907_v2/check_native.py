...
for dataset, rows in [('nr3d', 7899), ('sr3d', 17726)]:
    ...
    sys.argv = ['native-local-cpu-preparation'] + argv + ['--use_candidate_local_visual', '--candidate_local_visual_variant', 'extent']
...
result = {'schema': 'mcln-candidate-range-native-preparation-v1', 'reader_variant': 'extent', 'status': 'pass',
