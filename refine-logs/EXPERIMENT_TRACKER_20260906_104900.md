...
Updated: 2026-09-06 10:49 CST. Current acceptance: §20.79; teacher diagnosis and ScanRefer preparation: §20.81.
...
| ScanRefer teacher transfer | CPU synthetic and authoritative CLI checks PASS;512 fit rows queued after native probe | Zero updates;separate native selection, GT Hungarian, geometry and correspondence;not student training |
| ScanRefer joint readout | CPU actual-weight/synthetic gradient and state checks PASS;native16-row probe queued | No training yet;next GPU after legacy NrMask;11:03 observation then240s;floorpass advancesNr/Sr REC |
| Sparse point memory | Legacy Mask run;09:12 both3392/6687;no endpoint quality | No further Nr Mask formal evaluation under latest scope;ScanRefer GPU priority |
