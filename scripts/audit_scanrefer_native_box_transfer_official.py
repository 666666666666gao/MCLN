...
ARMS = ['protected_v99', 'gt_only_v99', 'gt_teacher_box_v99']
...
def audit_rows(directory):
    ...
    assert receipt['schema'] == 'mcln-scanrefer-native-box-transfer-official-v1'
    ...
    assert receipt['candidate_predeclared'] == 'gt_teacher_box_v99'
    ...
    promotion = promotion_check(actual['protected_v99'], actual['gt_teacher_box_v99'])
    ...
    return {'integrity_pass': True, 'formal_rows': 9508, 'metrics': actual,
            ...
            'system_gt_teacher_box_minus_protected': compare(records['protected_v99'], records['gt_teacher_box_v99']),
            'native_gt_teacher_box_minus_protected': rec_compare(native['protected_v99'], native['gt_teacher_box_v99']),
            'system_gt_teacher_box_minus_gt_only': compare(records['gt_only_v99'], records['gt_teacher_box_v99']),
            'native_gt_teacher_box_minus_gt_only': rec_compare(native['gt_only_v99'], native['gt_teacher_box_v99']),
            'system_gt_only_minus_protected': compare(records['protected_v99'], records['gt_only_v99']),
...
def main():
    ...
    result['schema'] = 'mcln-scanrefer-native-box-transfer-official-audit-v1'
