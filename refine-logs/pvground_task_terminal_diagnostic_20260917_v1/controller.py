...
with (root/"run.log").open("xb") as log:
    result=subprocess.run(['flock', '-n', '/root/autodl-tmp/mcln_v99_backbone_gpu0.lock', '/root/autodl-tmp/mcln_pvground_runtime_20260908_v1/venv/bin/python', '-u', '/root/autodl-tmp/mcln_pvground_task_terminal_diagnostic_20260917_v1/diagnose.py', '--spec', '/root/autodl-tmp/mcln_pvground_task_terminal_diagnostic_20260917_v1/spec.json'],env=env,stdout=log,stderr=subprocess.STDOUT)
