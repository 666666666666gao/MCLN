...
assert hashlib.sha256(downloaded['input_manifest.json']).hexdigest() == '2baa2e3cfbf95d558277267ca8489dcba4afbbc9541ad87458790558be3e4f73'
...
paths = [remote + '/' + arm + '_range_visual_state.pt' for arm in ['control', 'local']]
...
for arm, path in zip(['control', 'local'], paths):
...
proof = {'schema': 'mcln-range-fit-endpoint-check-v1', 'time_cst': now.isoformat(),
