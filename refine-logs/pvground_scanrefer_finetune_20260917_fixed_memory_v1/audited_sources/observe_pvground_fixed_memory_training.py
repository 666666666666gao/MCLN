...
roots=['/root/autodl-tmp/mcln_pvground_scanrefer_finetune_20260917_fixed_memory_v1',
       '/root/autodl-tmp/mcln_pvground_scanrefer_endpoint_audit_20260917_fixed_memory_v1',
       '/root/autodl-tmp/mcln_pvground_scanrefer_formal_20260917_fixed_memory_v1',
...
for root in roots:
    ...
    for name in ['run.log','controller.exit','capacity.json','memory_policy.json','receipt.json','audit.json','audit.exit','initial_audit.json','train.jsonl','decision.json','evaluation.exit','terminal_restore.json','cleanup_planned.json','cleanup_receipt.json','initial_D_E.json','terminal_D_E.json','initial_D_E.exit','terminal_D_E.exit','initial_D_E.log','terminal_D_E.log']:
        if name in names:
