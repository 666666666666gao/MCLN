"""One gated Nr3D F REC-competition forward/backward, with no optimizer update or saved model."""
import argparse
...
def main():
    ...
    competition,competition_counts=referit_competition_loss(output,batch,matching[1],'nr3d')
    ...
    print('PVG_NR_REC_COMPETITION_BACKWARD_PASS '+json.dumps(record),flush=True)
