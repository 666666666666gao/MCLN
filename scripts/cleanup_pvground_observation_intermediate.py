...
root=Path('/root/autodl-tmp/mcln_pvground_scanrefer_finetune_20260909_observation_v1').resolve()
audit_root=Path('/root/autodl-tmp/mcln_pvground_scanrefer_endpoint_audit_20260909_observation_v1')
...
assert not Path('/proc/29647').exists()
...
assert payload['source_query_read'] is True
assert payload['observation_state'] is True
assert payload['observation_module_sha256']==receipt['observation_module_sha256']
assert payload['source_query_module_sha256']==receipt['source_query_module_sha256']
