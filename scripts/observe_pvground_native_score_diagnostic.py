...
for name in ['controller.pid','controller.exit','run.log','input_selection.json','rows.json','diagnostic.json','candidate_values.npz']:
...
if 'diagnostic.json' in names:
    ...
    for filename,key in [('candidate_values.npz','arrays_sha256'),('rows.json','rows_sha256'),('input_selection.json','input_selection_sha256')]:
