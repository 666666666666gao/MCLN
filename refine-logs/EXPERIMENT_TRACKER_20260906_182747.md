...
Updated: 2026-09-06 18:27 CST. Acceptance: §20.79; actual native data and conditional GPU entry: §20.94.
...
| ScanRefer candidate local visual | 17:20 PID36968 live;128/2482 updates per arm;all6887 initial rows match both arms and previous E71/V99 | 2.585s/paired step;endpoint ETA19:30;observer41352 starts19:24 then240s;fixed formal9508 remains pending |
| ScanRefer local visual endpoint audit | Original-environment6 CPU tests and real frozen readout export/tamper checks PASS | Preparation only;actual2482-step endpoints pending;no GPU/formal rows;collect evidence without weight copies |
