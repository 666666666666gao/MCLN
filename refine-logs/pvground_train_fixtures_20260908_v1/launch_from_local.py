...
archive=repo/'refine-logs/pvground_train_fixtures_20260908_v1'
archive.mkdir()
root='/root/autodl-tmp/mcln_pvground_train_fixtures_20260908_v1'
...
_,stdout,stderr=client.exec_command('screen -dmS mcln_pvg_fixtures_v1 bash -c '+shlex.quote(inner),timeout=30)
...
receipt={'time_cst':datetime.datetime.now(datetime.timezone(datetime.timedelta(hours=8))).isoformat(),'process':process.strip(),'screen':'mcln_pvg_fixtures_v1','estimated_seconds':[90,240],'gpu_used':False}
