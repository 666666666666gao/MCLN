...
Updated: 2026-09-06 14:20 CST. Acceptance: §20.79; Scan updates: §20.83; Nr/Sr readiness: §20.84; endpoint audit prepared: §20.85.
...
| ScanRefer joint readout | 12:15:03 PID32521 live,both64/2482;6887 baseline rows identical | Pretrained joint continuation;terminal ETA15:32,next observer15:27 then240s;no formal gain yet |
| ScanRefer joint formal entry | OriginalPython3.7 compile/CLI and12 CPU tests PASS | Conditional fixed endpoint only;no formal manifest, GPU or9508 result yet |
| ScanRefer fixed endpoint audit | Original Python statistic tests and real pretrained metadata checks PASS | Terminal checkpoints not yet audited;106-room intervals are diagnostic only;no changed training or promotion gates |
