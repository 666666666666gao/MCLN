...
with (root/"run.log").open("xb") as log:
    result=subprocess.run(['flock', '-n', '/root/autodl-tmp/mcln_v99_backbone_gpu0.lock', '/root/autodl-tmp/mcln_pvground_runtime_20260908_v1/venv/bin/python', '-u', '/root/autodl-tmp/mcln_pvground_source_query_interface_20260908_v1/check.py', '--runtime', '/root/autodl-tmp/mcln_pvground_runtime_20260908_v1', '--fixtures', '/root/autodl-tmp/mcln_pvground_training_interface_20260908_v1/fixtures', '--output', '/root/autodl-tmp/mcln_pvground_source_query_interface_20260908_v1/results'],env=env,stdout=log,stderr=subprocess.STDOUT)
