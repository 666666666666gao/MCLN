#!/usr/bin/env python3
"""Build one provenance-bound checkpoint interpolation for evaluation only."""
...
def main():
    ...
    if int(base.get("epoch", -1)) != 26 or int(other.get("epoch", -1)) != 29:
    ...
    provenance = {
        "schema": "mcln-v99-weight-average-v1",
