...
def main():
    ...
    if args.preflight_only:
        write_json(output/'preflight_receipt.json',dict(status='pass',model_states_restored=True,optimizer_steps=0,new_checkpoints=0,assignment=capacity,script_sha256=sha(__file__),spec_sha256=sha(args.spec)))
        print('SEMANTIC_ASSIGNMENT_REAL_BATCH_PREFLIGHT_PASS',flush=True)
        return
