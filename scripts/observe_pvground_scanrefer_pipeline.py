...
formal_root = '/root/autodl-tmp/mcln_pvground_scanrefer_formal_20260908_v1'
archive = Path(__file__).resolve().parents[1] / 'refine-logs/pvground_scanrefer_finetune_20260908_v1'
...
formal_archive = archive.parent / 'pvground_scanrefer_formal_20260908_v1'
