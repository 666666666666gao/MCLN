"""Strict-load the prepared Sr3D parent into the current PV-Ground on CPU."""
import hashlib
import json
import os
...
# The Sr3D parent actually stores this deterministic buffer; keep it persistent.
...
print('SR_CPU_STRICT_LOAD_PASS '+json.dumps(record),flush=True)
