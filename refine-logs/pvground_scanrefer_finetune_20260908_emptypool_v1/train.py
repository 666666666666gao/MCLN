...
def main():
    ...
    def save_checkpoint(name,step_number,seen_rows):
        ...
        data.update(empty_pool_mask=True,empty_pool_module_sha256=spec['empty_pool_module_sha256'])
    ...
    receipt.update(empty_pool_mask=True,empty_pool_module_sha256=spec['empty_pool_module_sha256'])
