...
roots=[base/'mcln_pvground_scanrefer_finetune_20260908_vsaorder_v1',
       base/'mcln_pvground_scanrefer_finetune_20260908_sourcequery_v1']
...
for key in ['seed','batch_size','input_manifest','checkpoint_sha256','runtime','env_spec_sha256','primary_mode']:
