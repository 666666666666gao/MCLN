...
if args.terminal:
    ...
    scope = 'in-memory serialization fixture changing all 36 reader tensors; not trained weights'
...
result = dict(status='pass',time_cst=now(),scope=scope,parent_tensors=len(parent),
    ...
    module_sha256=train_spec['observation_module_sha256'],evaluator_sha256=sha(root/'evaluate.py'),
